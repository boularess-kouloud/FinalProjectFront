...
//
            ...
            {path: 'add-task', loadChildren: () => import('app/modules/ipfp/components/tasks/add-task/add-task-components.routes')},
            {path: 'update-user/:id', loadChildren: () => import('app/modules/ipfp/components/users/update-user/update-user-components.routes')},
            {path: 'update-task/:id', loadChildren: () => import('app/modules/ipfp/components/tasks/update-task/update-task/update-task-components.routes')},
